...
export default function RegistrationPage() {
  ...
  return (
    <div className="page-container registration-page-shell">
      <Toast message="Registration Successful!" show={showToast} />
      <div className="registration-auth-card">
        ...
        <div className="registration-right-panel">
          <div className="registration-form-card">
            ...
            <form onSubmit={handleSignUp} className="form-content registration-form-content">
